...
## Project Structure
    ...
    ├── testing_project_creatio_1  # Django project configurations
...
1. Clone this repo and `cd testing_project_creatio_1`
...
2. Clone this repo and `cd testing_project_creatio_1`
