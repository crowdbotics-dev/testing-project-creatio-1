"""
Django settings for testing_project_creatio_1 project.
...
ROOT_URLCONF = 'testing_project_creatio_1.urls'
...
WSGI_APPLICATION = 'testing_project_creatio_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testing_project_creatio_1 API",
    "DESCRIPTION": "API documentation for testing_project_creatio_1 App",
    "VERSION": "v1",
}
